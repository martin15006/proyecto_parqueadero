  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-white dark:bg-[#121212] border border-amber-200 dark:border-amber-500/30 rounded-2xl p-5 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-3xl font-black text-slate-900 dark:text-white">{contadores.pendientes}</p>
            </div>
          </div>
        </div>
        <div className="bg-white dark:bg-[#121212] border border-emerald-200 dark:border-emerald-500/30 rounded-2xl p-5 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-3xl font-black text-slate-900 dark:text-white">{contadores.aprobadas}</p>
            </div>
          </div>
        </div>
        <div className="bg-white dark:bg-[#121212] border border-rose-200 dark:border-rose-500/30 rounded-2xl p-5 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-3xl font-black text-slate-900 dark:text-white">{contadores.rechazadas}</p>
            </div>
          </div>
        </div>
      </div>

      <div className="bg-white dark:bg-[#121212] border border-slate-200 dark:border-white/5 rounded-2xl p-4 shadow-sm flex items-center gap-2 flex-wrap">
      ...
      {loading ? (
        <div className="bg-white dark:bg-[#121212] border border-slate-200 dark:border-white/5 rounded-2xl p-12 text-center">
          <p className="text-sm font-bold text-slate-500">Cargando solicitudes...</p>
        </div>
      ) : solicitudes.length === 0 ? (
        <div className="bg-white dark:bg-[#121212] border border-slate-200 dark:border-white/5 rounded-2xl p-12 text-center">
          <Clock size={40} className="mx-auto text-slate-300 mb-3" />
          <p className="text-lg font-black text-slate-700 dark:text-slate-200">No hay solicitudes</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          {solicitudes.map((sol) => (
            <div
              key={sol.idSolicitud}
              className="bg-white dark:bg-[#121212] border border-slate-200 dark:border-white/5 rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-all"
            >
              <div className="flex">
                <img
                ...
                <div className="flex-1 p-4">
                  <div className="flex items-start justify-between gap-2">
                    <div>
                      <p className="text-2xl font-black tracking-widest text-slate-900 dark:text-white">{sol.placa}</p>
                  ...
                  <div className="mt-3 space-y-1 text-xs font-semibold text-slate-700 dark:text-slate-300">
                    <p>
      ...
      >
        {seleccionada && (
          <div className="space-y-4">
            ...
            <div className="bg-slate-50 dark:bg-white/5 dark:text-slate-200 rounded-xl p-4 space-y-2 text-sm">
        ...
        <div className="space-y-3">
                  ...
                  <button
                    ...
                    className={`flex items-center gap-2 px-3 py-2.5 rounded-xl border text-left text-xs font-bold transition-all ${
                      activo
                        ...
                        : 'bg-white dark:bg-[#121212] border-slate-200 dark:border-white/10 text-slate-600 dark:text-slate-300 hover:border-slate-300 dark:hover:border-white/20'
                    }`}
                  >
                    <span
                      className={`w-4 h-4 rounded flex items-center justify-center border ${
                        activo ? 'bg-rose-500 border-rose-500' : 'border-slate-300 dark:border-white/20'
                      }`}
                    >
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full p-3 border border-slate-300 dark:border-white/10 dark:bg-white/5 dark:text-white rounded-xl text-sm font-medium focus:outline-none focus:ring-2 focus:ring-rose-500"
            />
